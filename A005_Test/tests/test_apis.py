...
import requests
from mercado_bitcoin.api import DaySummaryApi, TradesApi, MercadoBitcoinApi
...
def mocked_requests_get(*args, **kwargs):
    class MockResponde(requests.Response):
    ...
    if args[0] == "valid_endpoint":
        return MockResponde(json_data={"foo": "bar"}, status_code=200)
    else:
        return MockResponde(json_data=None, status_code=404)
